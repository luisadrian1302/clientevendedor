...
export default function PublicarSubProductos({ show, onClosevalue, onSave, subproductos = [], toast }) {
    ...
    function toggleSelection(id) {
        ...
        document.querySelector("#card" + id).classList.toggle('selected');
        // add or remove id
    }
                    ...
                    <div className="modal-content  ">
                        ...
                        <div className="modal-body  ">
                            ...
                            <div className="container py-5">
                                <h3 className="mt-2 mb-4">Seleccione los sub productos que desea publicar</h3>
                                ...
                                <div className="row" id="cardContainer">
                                    ...
                                    {productActve.map(e => (
                                        ...
                                        <div className="col-lg-4 col-xl-3 col-md-6 col-sm-6" key={e}>
                                            <div className="card" id={"card"+e.id} onClick={(element) => toggleSelection(e.id)}>
                                ...
                                <div className="mt-4" >
                                    <button className="btn btn-primary" onClick={(e) => getSelectedCards()}>Publicar productos</button>
                                </div>
                            </div>
