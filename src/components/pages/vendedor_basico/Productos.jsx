...
import { AlertTriangle, FileText, Home, MessageCircle, Package, PlusCircle, Search, ShoppingBag, Tag } from 'lucide-react';
                            ...
                            <Row xs={1} sm={3} md={4}>
                                ...
                                {products.length == 0 ? <>
                                    ...
                                    <div className="d-flex flex-column align-items-center justify-content-center" style={{ height: "500px", width: "100%" }}>
                                        ...
                                        <p className="text-muted">Aqui apareceran tus productos que vayas creando.</p>
                                    </div>
