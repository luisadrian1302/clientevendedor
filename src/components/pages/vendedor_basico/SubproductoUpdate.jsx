...
export const SubproductoUpdate = () => {
    ...
    async function guardarCambios(e) {
        ...
        if (!caracteristica.length ) {
            ...
            Swal.fire({
                icon: "error",
                text: "Coloque al menos una caractertistica en el sub producto"
            })
          return; 
        ...
        formdata.append("id_subproducto", id)  
        ...
        try {
            ...
            if (await response.status == 200) {
                Swal.fire({
                    icon: "success",
                    text: "Se actualizo el subproducto con exitó",
                    
                }).then((_) =>{
                    navegate("/products/edit/"+producto.id)
                })
            }else{
    ...
    useEffect(() => {
        ...
        async function traerProducto() {
            try {
                ...
                caracteristicaToCaractertisticaModal(data.caracteristicas)
    ...
    const handleSaveCaracteristicas = (data) => {
        ...
        if (element) {
            caracteristica[indexEdit] = data;
            setelement(null);
            setindexEdit(null);
        }else{
            
            caracteristica.push(data)
        }
        setcaracteristica(caracteristica);
        console.log("Datos guardados:", data, element);
    };
                                ...
                                <div className="row">
                                    ...
                                    <form className="col-lg-4 row " encType='multipart/form-data' >
                                        ...
                                        <div className="edit-group " style={{ display: "inline-block" }} >
                                            ...
                                            <h3 className="product-name" style={{ width: "100%" }}>
                                                <input type="number" className='non-input-style' value={inforacionGeneral.cantidad} placeholder='0'
                                                    onChange={(event) => validarValor(event, "cantidad", setInformacionGeneral)  } />
                                            </h3>
                                        </div>
                                        <div className="col-md-6 ">
                                            <p>Peso del producto: (en gramos)</p>
                                            <input type="text" className='form-control' value={inforacionGeneral.peso} placeholder='0'
                                                onChange={(event) => validarValor(event, "peso", setInformacionGeneral)   } />
                                        </div>

                                        <div className="col-md-6 ">
                                            <p>Grosor: (en CM)</p>
                                            <input type="text" className='form-control' value={inforacionGeneral.grosor} placeholder='0'
                                                onChange={(event) => validarValor(event, "grosor", setInformacionGeneral) } />
                                        </div>

                                        <div className="col-md-6  ">
                                            <p>Tamaño ancho del producto: (en cm)</p>
                                            <input type="text" className='form-control' value={inforacionGeneral.ancho} placeholder='0'
                                        ...
                                        <div className="col-md-6 ">
                                            ...
                                            <input type="text" className='form-control' value={inforacionGeneral.largo} placeholder='0'
